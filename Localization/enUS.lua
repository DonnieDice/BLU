...
L["MODULE_LOADED"] = "Module loaded: %s"
L["MODULE_CLEANED_UP"] = "Module cleaned up: %s"
...
L["LEVEL_UP"] = "Level up:"
L["ACHIEVEMENT_EARNED"] = "Achievement earned"
...
L["DEBUG_QUEST_ACCEPTED"] = "Quest accepted: %s"
L["DEBUG_QUEST_COMPLETED"] = "Quest completed: %s"
L["DEBUG_QUEST_PROGRESS"] = "Quest progress: %s"
L["DEBUG_ACHIEVEMENT_PROGRESS"] = "Achievement progress: %s - %s"
L["DEBUG_REPUTATION_INCREASED"] = "Reputation increased with %s: %s -> %s"
L["DEBUG_BATTLE_PET_LEVEL_SLOT"] = "Battle pet leveled up! Slot %d: %d -> %d"
L["DEBUG_BATTLE_PET_CAPTURED"] = "Battle pet captured! Index %s"
L["DEBUG_BATTLE_PET_LEVEL_NAME"] = "Battle pet '%s' leveled up to %d!"
L["DEBUG_HONOR_LEVEL_INCREASED"] = "Honor level increased: %d -> %d (%s)"
L["DEBUG_HONOR_LEVEL_RESYNC"] = "Honor level resynced downward: %d -> %d (%s)"
L["DEBUG_RENOWN_INCREASED"] = "Renown increased with %s: %d -> %d"
L["DEBUG_COVENANT_RENOWN_INCREASED"] = "Covenant Renown increased: %d -> %d"
L["DEBUG_TRADING_POST_PURCHASE"] = "Trading Post purchase successful!"
L["DEBUG_TRADING_POST_CURRENCY_GAINED"] = "Gained %d Trading Post currency!"
L["DEBUG_DELVE_SKIPPED_NON_RETAIL"] = "Delve Companion skipped (non-retail client)"
L["DEBUG_DELVE_COMPANION_LEVEL"] = "Delve Companion reached level %d!"
L["DEBUG_DELVE_COMPANION_LEVEL_GENERIC"] = "Delve Companion leveled up!"
L["DEBUG_DELVE_LIFE_LOST"] = "Delve life lost! %d -> %d remaining"
L["DEBUG_DELVE_LIFE_GAINED"] = "Delve life gained! %d -> %d remaining"
L["DEBUG_HOUSING_FAVOR_GAINED"] = "Housing favor increased: %d -> %d"
L["DEBUG_HOUSING_LEVEL_UP"] = "Housing level increased: %d -> %d"
L["DEBUG_HOUSING_REWARDS_RECEIVED"] = "Housing rewards received for level %d"
L["DEBUG_HOUSING_DECOR_COLLECTED"] = "Housing decor collected: %s"
